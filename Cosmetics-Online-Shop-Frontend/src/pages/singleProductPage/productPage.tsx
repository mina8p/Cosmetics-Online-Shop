...
//     dispatch(addItem({ productId: product._id, quantity, name: product.name }));
//   };
...
//             />
//             <button
//               className="w-full bg-purple-500 text-white rounded-3xl hover:bg-purple-700 focus:outline-none font-medium text-sm px-5 py-2.5 text-center mt-1"
